...
const cardData = [
    {
        ...
        backgroundImageUrl: "../../public/images/recommend_card1.png" // 실제 이미지 경로로 변경 필요
    },
    {
        description: "보다 정밀한 검색. 관심사와 필요에 꼭 맞춰 추천드립니다.",
        backgroundImageUrl: "../../public/images/recommend_card2.png"
    },
    {
        description: "로직에 기반한 분석. 검색의 효율을 최대한 높여드립니다.",
        backgroundImageUrl: "../../public/images/recommend_card3.png"
    }
];
