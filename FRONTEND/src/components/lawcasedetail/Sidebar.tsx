...
const Sidebar = ({
  ...
  const numberSelect = (currentNumber: string) => {
      ...
      {screenWidth <= 576 ? (
        <>
          <article className={style["sidebar"]}>
            <Flex className={style["sidebar__content"]}>
              <Flex
                className={
                  selectedNumber === "1"
                    ? `${style["sidebar__content__active"]} ${style["sidebar__content__box"]}`
                    : style["sidebar__content__box"]
                }
                onClick={() => numberSelect("1")}>
          ...
          {selectedNumber === "" ? null : selectedNumber === "1" ? (
