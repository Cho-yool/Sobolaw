  ...
  return (
    <div className={style["container"]}>
      ...
      <div className={style["pages"]}>
        ...
        <div>
          <p>
            ...
            제347조 제1항의 사기죄로 고소하오니, 수사하여 엄히 처벌하여 주시기
            바랍니다.
          </p>
        </div>
        ...
        <div>
          <p>
            ...
            (중고거래 사이트명)에서, (거래 물건) (이하 '본 중고거래 대상물')를
            판매한다는 글을 보고 연락해온 고소인에게 정상적인 본 중고거래
            대상물을 판매하겠다고 아래와 같이 거짓말을 하였습니다.
          </p>
          <p>
          ...
          <p>
            ...
            (입금날짜) (입금 시간)에 고소인으로부터 (입금 금액(원))을 피고소인의
            계좌로 이체받았습니다.
          </p>
        </div>
      </div>
      <div className={style["pages"]}>
        ...
        <div>
          <p>
            상기 내용에 따라 고소인은 피고소인을 다음과 같은 이유로 고소합니다:
          </p>
          <p>
            1. 상기 내용에 따라 고소인과 피고소인은 중고거래 사이트에서
            거래하였으며, 피고소인은 거래 내용을 위조하여 고소인을 기망하고 돈을
            받았습니다.
          </p>
          {/* 나머지 고소이유 내용 */}
        </div>
