  ...
  return (
    <div className={style["container"]}>
      ...
      <div className={style["pages"]}>
        ...
        <div className={style["numbers"]}>
          <ol>
            ...
            <li className={style["info"]}>
              ...
              접속하고 있던 위 <strong>{onlineServiceType}</strong>에서
              고소인에게 <strong>{reasonsForInsult}</strong>는 이유로 “
        ...
        <p className={style["sub-title"]}>1. 공연성에 관하여</p>
        ...
        <p className={style["sub-title"]}>2. 모욕성에 관하여</p>
        <div className={style["page-content"]}>
          <p className={style["info"]}>
        ...
        <p className={style["sub-title"]}>4. 고소인의 피해내용</p>
        <div className={style["page-content"]}>
          <p className={style["info"]}>
        ...
        <div>
          <p className={style["title"]}>위 첨부서류 - 각 1부</p>
        </div>
