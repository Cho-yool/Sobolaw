...
public interface LawServiceClient {
    ...
    PrecedentResponseDTO getPrecedentDetail(@PathVariable("precedentId") Long precedentId);

    /**
     * 판례 리스트 가져오기.
     */
    @PostMapping("/precedent/list")
    List<PrecedentListResponseDTO> getPrecedentList(@RequestBody Map<String, List<Long>> requestBody);
