 ...
 * 멤버 조회 ResponseDTO.
 */
public record MemberResponseDTO(Long memberId, String name, String email, LocalDate birthday, List<MemberKeywordDTO> memberKeyword, List<MemberRecentDTO> memberRecents, List<MemberPrecedentDTO> memberPrecedents) {
    ...
    public static MemberResponseDTO from(Member entity) {
        ...
        return new MemberResponseDTO(entity.getMemberId(), entity.getName(), entity.getEmail(), entity.getBirthday(), memberKeywordDTOs, memberRecentDTOs, memberPrecedentDTOs);
    }
}
