 ...
 * 모욕죄 소장 생성 DTO.
 */
public record LawsuitInsultCreateUpdateRequestDTO(String plaintiffName, String title, String plaintiffResidentRegistrationNumber, String plaintiffAddress, String plaintiffPhoneNumber,
