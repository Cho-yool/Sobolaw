 ...
 * 명예훼손 소장 생성 DTO.
 */
public record LawsuitDefamationCreateUpdateRequestDTO(String title, String plaintiffName, String plaintiffResidentRegistrationNumber, String plaintiffAddress,
