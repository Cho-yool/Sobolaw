...
public class MemberController {
    ...
    public BaseResponse<MemberPrecedentDTO> saveMemberPrecedent(@PathVariable Long memberId, @RequestBody PrecedentSaveRequestDTO precedentSaveRequestDTO) {
        return BaseResponse.success(HttpStatus.CREATED.value(), "판례를 저장합니다.", memberService.saveMemberPrecedent(memberId, precedentSaveRequestDTO));
    }
    ...
    public BaseResponse<MemberRecentDTO> saveMemberRecent(@PathVariable Long memberId, @RequestBody PrecedentSaveRequestDTO precedentSaveRequestDTO) {
        return BaseResponse.success(HttpStatus.CREATED.value(), "판례를 저장합니다.", memberService.saveMemberRecent(memberId, precedentSaveRequestDTO));
    }
    ...
    public BaseResponse<List<MemberKeywordDTO>> saveMemberKeyword(@PathVariable Long memberId, @RequestBody KeywordSaveRequestDTO keywordSaveRequestDTO) {
        return BaseResponse.success(HttpStatus.CREATED.value(), "키워드를 저장합니다.", memberService.saveMemberKeywords(memberId, keywordSaveRequestDTO));
    }
