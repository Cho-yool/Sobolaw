 ...
 * 사기죄 소장 생성 DTO.
 */
public record LawsuitFraudCreateUpdateRequestDTO(Long lawsuitId, String title, String plaintiffName, String plaintiffResidentRegistrationNumber, String plaintiffAddress, String plaintiffPhoneNumber,
